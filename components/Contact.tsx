  ...
  return (
    <div className="wrapper">
      <div className="max-w-5xl mx-auto flex flex-col gap-4 items-center justify-center">
        ...
        <a href="mailto:obinne.francis@gmail.com">
      ...
      <div className="mt-8 flex items-center flex-wrap   gap-8 justify-center">
        <SocialLink title="Github" link="https://github.com/FrancisObinne" />
        <SocialLink
          title="Linkedin"
          link="https://www.linkedin.com/in/francis-obinne-679471178/"
        />
        <SocialLink title="Nextjs" link="https://vercel.com/francis-obinnes-projects" />
      </div>
    </div>
  );
};
